...
ALLOWED_HOSTS = ['{{ app_subdomain }}.{{ domain_name }}']

# PostgreSQL database configuration. See the Django documentation for a complete list of available parameters:
#   https://docs.djangoproject.com/en/stable/ref/settings/#databases
DATABASE = {
    'NAME': 'netbox',         # Database name
    'USER': '{{ postgresql_user }}',               # PostgreSQL username
    'PASSWORD': '{{ postgresql_user_password }}',           # PostgreSQL password
    'HOST': 'netbox-db',      # Database server
...
SECRET_KEY = 'n+)HH5MVEB31%IL9DYULIXx5KbsTl%G6IDbh_m^kZ6Tmi*v8Cm'
